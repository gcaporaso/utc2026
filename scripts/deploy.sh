...
ssh "$PROD_HOST" "
    ...
    sudo chmod -R 777 $PROD_DIR/web/tmp
    sudo chmod -R 777 $PROD_DIR/web/cdu
    sudo chmod -R 777 $PROD_DIR/web/commissioni
    sudo chmod -R 777 $PROD_DIR/web/allegati
    sudo chmod -R 777 $PROD_DIR/web/pratiche
