...
\hail812\adminlte3\assets\PluginAsset::register($this)->add('sweetalert2','select2');
...
?>
    ...
    <?php $form = ActiveForm::begin([
                            'action'=>['modulistica/update', 'id'=>$id],
                            'id' => 'modulistica-update-form',
                            'options' => ['enctype' => 'multipart/form-data'],
                        ]); ?>
<div class="row">
        <div class="col-sm-2">
        <?php
        //$listacategorie =['Edilizia','Paesistica','Sismica','Urbanistica'] ;
        $listacategorie= ArrayHelper::map(app\models\Categorie::find()->asArray()->all(), 'idcategorie', 'descrizione');
            echo $form->field($model, 'categoria')->widget(Select2::classname(), [
                ...
                'size' => Select2::MEDIUM,
                'data' => $listacategorie,
                'options' => ['id' => 'lstcat', 'multiple' => false, 
...
<div class="row">
    <div class="col-sm-6" >
        <div><span>Modello attuale: </span> <?= Html::a($model->descrizione,['modulistica/download','filename'=> $model->path . $model->nomefile]);  ?></div>
    </div>
</div> 
...
<div class="row">
    <div class="col-sm-6" >
        <div class="custom-file">
            <?php 
                echo $form->field($model, 'fname')->fileInput(['id'=>'input-filemodid','class'=>'custom-file-input']) 
                    ->label('scegli file con modello ....',['class'=>'custom-file-label']) 
            ?>
            
            
        <?php 
//            echo $form->field($model, 'nomefile')->widget(FileInput::classname(), [
//            'name' => 'attachment_50',
//            'pluginOptions' => [
//            'showPreview' => false,
//            'browseLabel' => '',
