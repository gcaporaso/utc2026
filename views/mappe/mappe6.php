...
$this->registerJsFile('js/perimetro_comunale.js');
...
const catasto = L.tileLayer.wms('https://wms.cartografia.agenziaentrate.gov.it/inspire/wms/ows01.php?language=ita&', wmsOptions);
...
// var vcatLayer = L.geoJSON(catastale);
...
var layerPermessi = L.layerGroup().addTo(map);
var layerSCIA = L.layerGroup().addTo(map);
var layerSCA = L.layerGroup().addTo(map);
