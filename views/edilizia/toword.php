...
$this->title = 'Generazione Documenti per Pratica Edilizia ' . $model->edilizia_id;
...
//}
   ...
   ?> 
    <table  style="width:100%;border: 1px solid grey;padding:15px">
        ...
        <tbody>
            <tr >
                <td class="col-sm-2" style="padding:15px;border:1px solid grey;">Permesso di Costruire Ordinario </td>
                <td class="col-sm-2" style="border:1px solid grey;">
                    <?php
                    echo Html::a('<i class="glyphicon glyphicon-equalizer"> Permesso di Costruire</i>', Url::to(['edilizia/permesso', 'id' => $model->edilizia_id]), [
...
//                        ]
                ...
                <td class="col-sm-2" style="border:1px solid grey;">
                    <?php
                    echo Html::a('<i class="glyphicon glyphicon-equalizer"> Avviso Rilascio Permesso</i>', Url::to(['edilizia/generaPermesso', 'id' => $model->edilizia_id]), [
                        'title' => 'Permesso di Costruire',
                        'class' => 'btn btn-primary',
//                        'data' => [
//                       //'confirm' => '¿Realmente deseas eliminar este elemento?',            
...
//                        ]
                ...
                <td class="col-sm-2" style="border:1px solid grey;">
                    <?php
                    echo Html::a('<i class="glyphicon glyphicon-equalizer"> Richiesta Integrazioni</i>', Url::to(['edilizia/generaPermesso', 'id' => $model->edilizia_id]), [
                        'title' => 'Permesso di Costruire',
                        'class' => 'btn btn-primary',
//                        'data' => [
//                       //'confirm' => '¿Realmente deseas eliminar este elemento?',            
...
//                        ]
            ...
            <tr>
                <td class="col-sm-2" style="padding:15px;border:1px solid grey;">Autorizzazione/Compatibilità Paesaggistica</td>
                <td class="col-sm-2" style="border:1px solid grey;">
                    <?php
                    echo Html::a('<i class="glyphicon glyphicon-trash"> Autorizzazione Paesaggistica</i>', Url::to(['edilizia/rilascio', 'id' => $model->edilizia_id]), [
...
//                   ]
                ...
                <td class="col-sm-2" style="padding:15px;border:1px solid grey;">Proposta Autorizzazione Paesaggistica</td>
                <td class="col-sm-2" style="border:1px solid grey;">
                    <?php
                    echo Html::a('<i class="glyphicon glyphicon-trash"> Proposta Autorizzazione Paesaggistica</i>', Url::to(['edilizia/rilascio', 'id' => $model->edilizia_id]), [
                   'title' => 'Autorizzazione Paesaggistica',
                   'class' => 'btn btn-primary',
//                   'data' => [
//                       'confirm' => '¿Realmente deseas eliminar este elemento?',            
...
//                   ]
                ...
                <td class="col-sm-2" style="border:1px solid grey;">
                    <?php
                    echo Html::a('<i class="glyphicon glyphicon-trash"> Comunicazione Responsabile Procedimento</i>', Url::to(['edilizia/rilascio', 'id' => $model->edilizia_id]), [
                   'title' => 'Autorizzazione Paesaggistica',
                   'class' => 'btn btn-primary',
//                   'data' => [
//                       'confirm' => '¿Realmente deseas eliminar este elemento?',            
...
//                   ]
            ...
            <tr>
                <td class="col-sm-2" style="padding:15px;border:1px solid grey;">Richiesta Pagamento Oneri Concessori</td>
                <td class="col-sm-2" style="padding:15px;border:1px solid grey;">       
                    <?php 
                    echo Html::a('<i class="glyphicon glyphicon-pencil"> Richiesta Pagamento Oneri </i>', Url::to(['edilizia/altro', 'id' => $model->edilizia_id]), [
                   'title' => 'Altro ..',
                   'class' => 'btn btn-primary',
                    ]);
                    ?>                   
                </td>
                <td class="col-sm-2" style="padding:15px;border:1px solid grey;">Permesso Costruire Sanatoria</td>
                <td class="col-sm-2" style="padding:15px;border:1px solid grey;">       
                    <?php 
                    echo Html::a('<i class="glyphicon glyphicon-pencil"> Permesso Costruire Sanatoria </i>', Url::to(['edilizia/altro', 'id' => $model->edilizia_id]), [
                   'title' => 'Altro ..',
                   'class' => 'btn btn-primary',
                    ]);
                    ?>                   
                </td>
                <td class="col-sm-2" style="padding:15px;border:1px solid grey;">Altro ... </td>
                <td class="col-sm-2" style="padding:15px;border:1px solid grey;">       
                    <?php 
                    echo Html::a('<i class="glyphicon glyphicon-pencil"> Altro </i>', Url::to(['edilizia/altro', 'id' => $model->edilizia_id]), [
                   'title' => 'Altro ..',
                   'class' => 'btn btn-primary',
                    ]);
                    ?>                   
