    ...
    <div class="row">
        <div class="card card-secondary col-md-12 text-sm"  style="margin-top: 10px" >
             <div class="card-header" >
                <h3 class="card-title">Riepilogo Dati Pratica Paesistica</h3>
...
<div class="row">
    <div class="card card-default col-md-12"  >
            <!-- TOOLBAR -->
            <div class="card-header" >
                <?= Html::a('Composizione Atti', ['paesistica/atti','idpratica'=>$idpratica], ['class'=>'btn btn-success']) ?>
            </div>
    </div>
</div>
    ...
    <div class="row">
        ...
        <div class="card card-secondary col-md-12"  style="margin-top: 5px" >
            <!-- INTESTAZIONE -->
            <div class="card-header" >
                <h3 class="card-title">Gestione Allegati Pratica Paesistica</h3>
                <div class="card-tools">
                    <button type="button" class="btn btn-tool" data-card-widget="collapse">
                    <i class="fas fa-minus"></i>
                    </button>
                ...
                <div class="row">
                    ...
                    <!-- **************** -->
                        ...
                        <?php $form = ActiveForm::begin([
                            'action'=>['paesistica/allegati', 'idpratica'=>$idpratica],
            ...
            <div class="row">    
                            ...
                            [
                                ...
                                'buttons'=>['delete' => function ($url,$model) use ($idpratica) {
                                               ...
                                               $url = Url::toRoute(['paesistica/cancellafile','id'=>$model->idallegati_paesistica,'idpratica'=>$idpratica]);
                                ...
                                'value' => function ($data) {
                                    ...
                                    return Html::a($data['nomefile'],['paesistica/download','filename'=> $data['path'] . $data['nomefile']]);
                                },
