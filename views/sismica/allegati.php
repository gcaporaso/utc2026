...
<div class="row">
    <div class="card card-default col-md-12"  >
            <!-- TOOLBAR -->
            <div class="card-header" >
                <?= Html::a('Soggetti Coinvolti', ['sismica/soggetti','idpratica'=>$idpratica], ['class'=>'btn btn-success']) ?>
                ...
                <div class="row">
                    ...
                    <!-- **************** -->
                        ...
                        <?php $form = ActiveForm::begin([
                            'action'=>['sismica/allegati', 'idpratica'=>$idpratica],
...
//                                        'width'=>'2%',
                                'buttons'=>['delete' => function ($url,$model) use ($idpratica) {
                                               ...
                                               $url = Url::toRoute(['sismica/cancellafile','id'=>$model->idallegati,'idpratica'=>$idpratica]);
...
//                                        'order'=>DynaGrid::ORDER_FIX_LEFT],
                                ...
                                'value' => function ($data) {
                                    ...
                                    return Html::a($data['nomefile'],['sismica/download','filename'=> $data['path'] . $data['nomefile']]);
                                },
