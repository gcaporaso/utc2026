...
<?php $this->beginBody() ?>
<?php $projectId = $this->params['projectId'] ?? null; ?> 
<?php $projectName = $this->params['Name'] ?? ''; ?> 
...
<div class="wrapper">
    ...
    <?= $this->render('mynavbar', ['Name'=>$projectName, 'pId'=>$projectId]) ?>
    <!-- /.navbar -->

    <!-- Main Sidebar Container -->
    <?= $this->render('leftbimbar', ['content' => $content]) ?> <!-- , 'assetDir' => $assetDir]) ?> -->
